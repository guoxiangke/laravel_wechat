...
return [
    ...
    'payment' => [
        'default' => [
            ...
            'cert_path'          => env('WECHAT_PAYMENT_CERT_PATH', '/var/www/html/cert/apiclient_cert.pem'),    // XXX: 绝对路径！！！！
            'key_path'           => env('WECHAT_PAYMENT_KEY_PATH', '/var/www/html/cert/apiclient_key.pem'),      // XXX: 绝对路径！！！！
